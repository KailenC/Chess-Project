...
static int CountBits(U64 bitboard) {
    int bitCount = 0;
...
static int GetLSBIndex(const U64 bitboard) {
...
public:
    ...
    */
    ...
    int capturedPieceStack[MAX_PLY];
    int ply = 0;
    int enPassantSquare = -1;
    int epSquareStack[MAX_PLY];
    int castleRights = 0b1111;
    int castleRightsStack[MAX_PLY];
